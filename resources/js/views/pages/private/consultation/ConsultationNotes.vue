...
export default {
    ...
    async mounted() {
        try {
            setTimeout(async () => {
                ...
                const result = await this.consultationNoteService.getConsultationNotes(consultation.public_id)
    ...
    setup() {
        ...
        const consultationNoteService = new ConsultationNoteService()
